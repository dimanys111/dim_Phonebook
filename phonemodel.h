...
public:
    ...
    static Person from_data_stream(QDataStream& ds)
    {
        Person person;
        ds >> person.m_name;
        ds >> person.m_phone;
...
public:
    ...
    Q_INVOKABLE bool open(const QUrl& file_name);
    Q_INVOKABLE bool save(const QUrl& file_name);
    ...
    Q_INVOKABLE void set_sort(bool b);
